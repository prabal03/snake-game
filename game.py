...
# inserting image
image = pygame.image.load("snake.jpeg")
image1 = pygame.image.load("index.jpeg")
...
def welcome():
    ...
    while exit_game:
        ...
        text_screen("Welcome To The Snake Game", black, 150, 20)
        text_screen("press spacebar to continue", black, 150, 200)
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                exit_game = False
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_SPACE:
                    pygame.mixer.music.load("cartoon.mp3.mp3")
...
def game_loop():
    ...
    while exit_game:
        if game_win:
            ...
            text_screen("Level: " + str(level), black, 200, 5)
            text_screen(" Max Level: 4", black, 400, 5)
            ...
            if len(snake_lst) > snake_len:
                del snake_lst[0]
            if snake_x < 0 or snake_x > screen_width or snake_y < 0 or snake_y > screen_height or head in snake_lst[:-1]:
                game_over = True
